 ...
 * @author Joao
 */
@Component(value = "tipoAlimentoConverter")
public class TipoAlimentoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        return this.tipoAlimentoService.findById(getKey(value));
    }
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof TipoAlimento) {
            TipoAlimento o = (TipoAlimento) object;
            return getStringKey(o.getIdTipoAlimento());
        } else {
